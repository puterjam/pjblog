...
Class c_general
	...
	Public Function SaveGeneral
		Dim Arrays
		Arrays = Array(Array("blog_Name", SiteName), Array("blog_Title", blog_Title), Array("blog_master", blog_master), Array("blog_email", blog_email), Array("blog_KeyWords", blog_KeyWords), Array("blog_Description", blog_Description), Array("blog_URL", SiteURL), Array("blog_affiche",""), Array("blog_about", blog_about), Array("blog_html", blog_html), Array("blog_postFile", blog_postFile), Array("blog_SplitType", blog_SplitType), Array("blog_introChar", blog_introChar), Array("blog_introLine", blog_introLine), Array("blog_PerPage", blog_PerPage), Array("blog_ImgLink", blog_ImgLink), Array("blog_commPage", blog_commPage), Array("blog_commTimerout", blog_commTimerout), Array("blog_commLength", blog_commLength), Array("blog_validate", blog_validate), Array("blog_commUBB", blog_commUBB), Array("blog_commIMG", blog_commIMG), Array("blog_Disregister", blog_Disregister), Array("blog_CountNum", blog_CountNum), Array("blog_FilterName", blog_FilterName), Array("blog_FilterIP", blog_FilterIP))
