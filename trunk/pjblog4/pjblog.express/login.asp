  ...
  <form id="checkUser" action="../pjblog.logic/log_User.asp?action=login" method="post">
    <div id="MsgContent">
      ...
      <div id="MsgBody" style="text-align:left; padding-left:150px;">
	   ...
	   <label><input name="validate" type="text" size="4" class="userpass" maxlength="4" id="validate" onFocus="ceeevio.GetCode('../pjblog.common/GetCode.asp', 'checkcode')" onKeyUp="/*ceeevio.CheckCode('validate', 'isok_checkcode')*/"/> <span id="checkcode"/> <span id="checkcode"><label style="cursor:pointer;" onClick="CheckForm.User.GetCode('../pjblog.common/GetCode.asp', 'checkcode')"><%=lang.Set.Asp(4)%></label></span> <span id="isok_checkcode"></span></label><br/>
