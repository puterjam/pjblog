...
'    更新时间: 2005-6-24
'==================================
If session(Sys.CookieName&"_System") = True And memName<>Empty And stat_Admin = True Then
%>
...
<body class="headbody">
 <div class="headmain">
   ...
   <div style="height:70px;background:url('../images/Control/Pic2.jpg') no-repeat;">
   	<div style="position: absolute; font-family: verdana; top: 10px; font-size: 10px; color: rgb(158, 169, 197); left: 143px;">PJBlog3 v<%=Sys.version%> - <%=Asp.DateToStr(Sys.UpdateTime,"mdy")%></div>
   </div>
 </div>
</body>
</html>
