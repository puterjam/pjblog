...
Public Sub BaseSetting
	Response.Write(yellowBox("快速通道:<br />1.初始化数据点击这里"))
%>
	<div class="basediv">
...
%>
	<div class="basediv">
    	...
    	<div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">根据需要选择你喜欢的模式:</div>
        <div>
        ...
        <div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">数据初始化:</div>
        <div class="setting">
...
%>
	<div class="basediv">
    	<div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">网站首页SEO设置:</div>
        <div class="setting">
        	...
        	<table cellpadding="3" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><textarea class="text" style="width:300px; height:50px;" name="blog_Description"><%=blog_Description%></textarea></td>
                ...
                <tr>
					...
					%>
                            	<tr>
                                	<td width="330">发送到: <%=Trim(conPing("Ping_Name"))%></td>
                                	<td width="150">编辑 | 删除</td>
                                </tr>      
                     <%
						conPing.MoveNext
						Loop
...
%>
	<div class="basediv">
    	<div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">自动发信设置:</div>
        <div class="setting">
        	<table cellpadding="3" cellspacing="0" width="100%">
                <tr>
                	<td class="tagname">SMTP服务端地址</td>
                    <td><input name="blog_KeyWords" type="text" class="text" value="" maxlength="123" size="50" /></td>
                    <td>比如 smtp.pjblog4.com</td>
                </tr>
                <tr>
                	<td class="tagname">发信邮箱账号</td>
                    <td><input name="blog_Description" type="text" class="text" value="<%=blog_Description%>" maxlength="176" size="50" /></td>
        ...
        <div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">手机上网WAP服务设置:</div>
        <div class="setting">
        	<table cellpadding="3" cellspacing="0" width="100%">
                <tr>
                	<td class="tagname" width="210">允许使用wap方式浏览博客</td>
                    <td><input name="blog_wap" type="checkbox" value="1" checked="checked"  /></td>
                    <td></td>
                </tr>
                <tr>
                	<td class="tagname">允许wap使用简单HTML</td>
                    <td><input name="blog_wapHTML" type="checkbox" value="1" checked="checked"  /></td>
                    <td></td>
                </tr>
                <tr>
                	<td class="tagname">允许wap显示图片</td>
                    <td><input name="blog_wapImg" type="checkbox" value="1"   /></td>
                    <td></td>
                </tr>
                <tr>
                	<td class="tagname">允许wap保留文章超链接</td>
                    <td><input name="blog_wapURL" type="checkbox" value="1"   /></td>
                    <td></td>
                </tr>
                <tr>
                	<td class="tagname">允许通过wap登录</td>
                    <td><input name="blog_wapLogin" type="checkbox" value="1" checked="checked"  /></td>
                    <td></td>
                </tr>
                <tr>
                	<td class="tagname">允许通过wap发评论</td>
                    <td><input name="blog_wapComment" type="checkbox" value="1"   /></td>
                    <td></td>
                </tr>
                <tr>
                	<td class="tagname">Wap日志显示数量</td>
                    <td><input name="blog_wapNum" type="text" size="5" class="text" value="5"/> 篇</td>
                    <td></td>
                </tr>
            </table>
        </div>
        <p><input type="button" value="确定保存" class="button" /></p>
    </div>
<%
End Sub
...
%>
	<div class="basediv">
    	<div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">日志基本设置:</div>
        <div class="setting">
        ...
        <div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">评论设置:</div>
        <div class="setting">
        	<table cellpadding="3" cellspacing="0" width="100%">
                <tr>
...
%>
	<div class="basediv">
    	<div style="margin:12px 0; line-height:30px; border-bottom:1px solid #7BBCF6">注册模式选择:</div>
        <div>
        	<p><label for="p4" ><input id="p4" name="blog_Disregister" type="radio" value="0" <%if blog_Disregister = 0 then response.write ("checked=""checked""")%>/> 不允许注册 (不推荐)<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#999">用户将无法在您站上注册!</span> <br/></label></p>
            <p><label for="p5" ><input id="p5" name="blog_Disregister" type="radio" value="1" <%if blog_Disregister = 1 then response.write ("checked=""checked""")%>/> 普通注册 (推荐)<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#999">只需要填写用户名和密码来注册!</span> <br/></label></p>
            <p><label for="p6" ><input id="p6" name="blog_Disregister" type="radio" value="2" <%if blog_Disregister = 2 then response.write ("checked=""checked""")%>/> 验证注册<span style="color:#f00;font-size:8px">new</span> (需要服务端JMail组件的支持)<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#999">通过发送邮件来完成注册! </span> <br/></label></p>
        </div>
        <div><input type="button" value="确定" class="button" /></div>
    </div>
<%
End Sub
%>